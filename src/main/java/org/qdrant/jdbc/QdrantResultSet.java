...
public class QdrantResultSet extends BaseResultSet {
    private final Statement statement;
    private final List<QdrantRow> rows;
    private int cursor = -1;
    private boolean closed = false;

    public QdrantResultSet(Statement statement, List<QdrantRow> rows) {
    ...
    private QdrantRow current() throws SQLException {
    ...
    public String getString(String columnLabel) throws SQLException {
        if ("id".equalsIgnoreCase(columnLabel)) return getString(1);
        if ("payload".equalsIgnoreCase(columnLabel)) return getString(2);
        if ("vector".equalsIgnoreCase(columnLabel)) return getString(3);
        throw new SQLException("Invalid column label: " + columnLabel);
    }

    @Override
    public ResultSetMetaData getMetaData() throws SQLException {
        return new QdrantResultSetMetaData();
    }
    ...
    @Override public boolean getBoolean(int columnIndex) throws SQLException { return Boolean.parseBoolean(getString(columnIndex)); }
    @Override public byte getByte(int columnIndex) throws SQLException { return Byte.parseByte(getString(columnIndex)); }
    @Override public short getShort(int columnIndex) throws SQLException { return Short.parseShort(getString(columnIndex)); }
    @Override public int getInt(int columnIndex) throws SQLException { return Integer.parseInt(getString(columnIndex)); }
    @Override public long getLong(int columnIndex) throws SQLException { return Long.parseLong(getString(columnIndex)); }
    @Override public float getFloat(int columnIndex) throws SQLException { return Float.parseFloat(getString(columnIndex)); }
    @Override public double getDouble(int columnIndex) throws SQLException { return Double.parseDouble(getString(columnIndex)); }
    @Override public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException { return new BigDecimal(getString(columnIndex)); }
    @Override public byte[] getBytes(int columnIndex) throws SQLException { return getString(columnIndex).getBytes(); }
    ...
    @Override public int findColumn(String columnLabel) throws SQLException {
        if ("id".equalsIgnoreCase(columnLabel)) return 1;
        if ("payload".equalsIgnoreCase(columnLabel)) return 2;
        if ("vector".equalsIgnoreCase(columnLabel)) return 3;
    ...
    @Override public BigDecimal getBigDecimal(int columnIndex) throws SQLException { return new BigDecimal(getString(columnIndex)); }
    ...
    @Override public boolean absolute(int row) throws SQLException { cursor = row - 1; return cursor >= 0 && cursor < rows.size(); }
    @Override public boolean relative(int rows) throws SQLException { cursor += rows; return cursor >= 0 && cursor < this.rows.size(); }
    ...
    @Override public void updateCharacterStream(String columnLabel, Reader x, int length) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    ...
    @Override public void updateNCharacterStream(String columnLabel, Reader x, long length) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    ...
    @Override public void updateCharacterStream(String columnLabel, Reader x, long length) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    ...
    @Override public void updateNCharacterStream(String columnLabel, Reader x) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    ...
    @Override public void updateCharacterStream(String columnLabel, Reader x) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    ...
    @Override public void updateObject(int columnIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    @Override public void updateObject(String columnLabel, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    @Override public void updateObject(int columnIndex, Object x, SQLType targetSqlType) throws SQLException { throw new SQLFeatureNotSupportedException(); }
    @Override public void updateObject(String columnLabel, Object x, SQLType targetSqlType) throws SQLException { throw new SQLFeatureNotSupportedException(); }
